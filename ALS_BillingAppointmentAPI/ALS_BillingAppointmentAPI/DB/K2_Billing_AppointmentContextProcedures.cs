...
namespace ALS_BillingAppointmentAPI.DB
{
    public partial class K2_Billing_AppointmentContext
    {
        ...
        public virtual K2_Billing_AppointmentContextProcedures Procedures
        {
            get
            {
    ...
    public partial class K2_Billing_AppointmentContextProcedures
    {
        ...
        public virtual async Task<List<usp_GetNewRunningNoResult>> usp_GetNewRunningNoAsync(string IsBilling, string PackageDeliveryType, string PackagelabBranch, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var sqlParameters = new []
            {
                ...
                new SqlParameter
                {
                    ParameterName = "PackagelabBranch",
                    Size = 100,
                    Value = PackagelabBranch ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.NVarChar,
                },
                parameterreturnValue,
            };
            var _ = await _context.SqlQueryAsync<usp_GetNewRunningNoResult>("EXEC @returnValue = [dbo].[usp_GetNewRunningNo] @IsBilling, @PackageDeliveryType, @PackagelabBranch", sqlParameters, cancellationToken);
