...
namespace ALS_BillingAppointmentAPI.DB
{
    public partial class K2_Billing_AppointmentContext : DbContext
    {
        ...
        public virtual DbSet<TbMHolidays> TbMHolidays { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TbMHolidays>(entity =>
            {
                entity.HasKey(e => e.HolidaysId);

                entity.ToTable("TB_M_HOLIDAYS");
                ...
                entity.Property(e => e.HolidaysDate)
                    .HasColumnName("HOLIDAYS_DATE")
                    .HasColumnType("datetime");

                entity.Property(e => e.HolidaysDays)
                    .HasColumnName("HOLIDAYS_DAYS")
                    .HasMaxLength(50);
            });
            ...
            modelBuilder.Entity<TbRInvoice>(entity =>
            {
                ...
                entity.Property(e => e.ConsolidateBillingClientCode).HasMaxLength(500);

                entity.Property(e => e.ConsolidateBillingCompanyName).HasMaxLength(500);

                entity.Property(e => e.ConsolidateBillingDeliverToCity).HasMaxLength(500);

                entity.Property(e => e.ConsolidateBillingDeliverToLocation).HasMaxLength(500);

                entity.Property(e => e.ConsolidateBillingDeliverToOffice).HasMaxLength(500);

                entity.Property(e => e.ConsolidateBillingDeliverToState).HasMaxLength(500);

                entity.Property(e => e.ConsolidateBillingDeliverToZip).HasMaxLength(500);

                entity.Property(e => e.ConsolidateBillingFlag).HasMaxLength(50);

                entity.Property(e => e.ConsolidateBillingOtherLocation).HasMaxLength(500);

                entity.Property(e => e.ConsolidateBillingToMobile).HasMaxLength(500);

                entity.Property(e => e.ConsolidateBillingToPersonName).HasMaxLength(500);

                entity.Property(e => e.ConsolidateBillingToTelephone).HasMaxLength(500);
                ...
                entity.Property(e => e.GenerateBillingAppointmentPerInvoice).HasMaxLength(50);
                ...
                entity.Property(e => e.IsCbCreated).HasColumnName("Is_CB_Created");

                entity.Property(e => e.QuoteCode)
                    .HasColumnName("Quote_Code")
                    .HasMaxLength(50);

                entity.Property(e => e.ReportLocation).HasColumnName("Report_Location");
